...
//--------------------------------------------------------------------------------------------------
// we need for isDayTime() hour as an integer, lets calculate every date ;-)
...
//
//    if (19 > HH >= 7){
//        DEBUG_OUT.printf(" 3 Es ist Tag ! %i h\r\n",HH);
//        return true;
//        }
//    else {
//        DEBUG_OUT.printf(" 3 Es ist Nacht ! %i h\r\n",HH);
//        return false;
//        }
//}
//---isDayTime-----------------------------------------------------------------------------------------------
...
//-----------------
  ...
  if ((jetztMinuteU >= SunUp) &&(jetztMinuteO <= SunDown)){
        DEBUG_OUT.printf("Es ist Tag ! %i h\r\n",HH);
        return true;
        }
  else {
