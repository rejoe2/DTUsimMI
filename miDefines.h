...
#ifndef __MI_DEFINES_H__
#define __MI_DEFINES_H__
...
// MI300
//-------------------------------------
const byteAssign_t mi1chAssignment[] = { //review Channel assignment most will be on RxChannel!
...
#define MI1CH_LIST_LEN     (sizeof(mi1chAssignment) / sizeof(byteAssign_t))


//-------------------------------------
// MI-600
//-------------------------------------
const byteAssign_t mi2chAssignment[] = {//review Channel assignment most will be on RxChannel!
    { FLD_UDC, UNIT_V,   CH1,  2, 2, 10   },
    { FLD_IDC, UNIT_A,   CH1,  4, 2, 100  },
    { FLD_PDC, UNIT_W,   CH1,  6, 2, 10   },
...
#define MI2CH_LIST_LEN     (sizeof(mi2chAssignment) / sizeof(byteAssign_t))


//-------------------------------------
// MI1500
//-------------------------------------
const byteAssign_t mi4chAssignment[] = {//review Channel assignment
    { FLD_UDC, UNIT_V,   CH1,  2, 2, 10   },
    { FLD_IDC, UNIT_A,   CH1,  4, 2, 100  },
...
#define MI4CH_LIST_LEN     (sizeof(mi4chAssignment) / sizeof(byteAssign_t))


#endif /*__MI_DEFINES_H__*/
